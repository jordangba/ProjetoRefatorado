...
public class ControllerSolicitacao implements Serializable {
	...
	public String addSolicitacaoPonto(Usuario donaDaSolicitacao, Carona carona,
			String ponto) {
		PontoEncontro pontos = new PontoEncontro(ponto,
				donaDaSolicitacao.getIdUser(), carona.getIdCarona());
	...
	public String getAtributo(String idSolicitacao, String atributo) {
		...
		if (atributo.equals("origem")) {
			retorno = this.solicitacoesSistema.get(idSolicitacao).getCarona()
					.getOrigem();
		} else if (atributo.equals("destino")) {
			retorno = this.solicitacoesSistema.get(idSolicitacao).getCarona()
					.getDestino();
		} else if (atributo.equals("Dono da carona")) {
			retorno = this.solicitacoesSistema.get(idSolicitacao)
					.getDonoCarona().getNome();
		} else if (atributo.equals("Dono da solicitacao")) {
			retorno = this.solicitacoesSistema.get(idSolicitacao)
					.getDonoDaSolicitacao().getNome();
		} else if (atributo.equals("Ponto de Encontro")) {
			retorno = this.solicitacoesSistema.get(idSolicitacao).getPonto()
					.toString();
		}
	...
	public void desistirRequisicao(Usuario donoSolicitacao, Carona carona,
			String idSolicitacao) {
		this.solicitacoesSistema.get(idSolicitacao).desistirSolicitacao(
				donoSolicitacao, carona);
	}
